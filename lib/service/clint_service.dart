...
final class ClientService{
  ...
  static const String _baseUrl2 = "https://65e892d74bb72f0a9c4fcca0.mockapi.io";

  static const String _version = "/v1";

  static const String apiGetNutritions = "$_version/nutrition";
  static const String apiMockPost = "exam";
  ...
  static Future<String?> get({required String api, Map<String, dynamic>? param}) async {
    ...
    try{
      ...
      request.headers.set("x-api-key", "JJAn8CQMAubnvpP9Fbl2GA==AmrbblYnb3QtxQS1");
  ...
  static Future<String?> post({required String api, required Map<String, Object?> data}) async {
    ...
    Uri url = Uri.parse('$_baseUrl2/$api');
